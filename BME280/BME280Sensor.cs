...
namespace BME280
{
    public class BME280Sensor
    {
        ...
        private const byte BME280_DEFAULT_ADDRESS = 0x77;
        private readonly byte BME280_Address;
        ...
        public BME280Sensor() : this(BME280_DEFAULT_ADDRESS)
        {
        }

        public BME280Sensor(byte address)
        {
